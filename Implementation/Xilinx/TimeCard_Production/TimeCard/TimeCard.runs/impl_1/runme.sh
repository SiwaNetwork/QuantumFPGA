...
HD_PWD='C:/Users/SHIWA/Documents/GitHub/QUANTUM/Qantum Time-Card/FPGA/Open-Source/Implementation/Xilinx/TimeCard_Production/TimeCard/TimeCard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TimeCardTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TimeCardTop.tcl -notrace
